...
installdir="$HOME/Detonator"
chkmark="[$gSearching$e]"
div="$g##################################################################$e\n"
...
| $$  | $$| $$_____/  | $$ /$$| $$  | $$| $$  | $$ /$$__  $$  | $$ /$$| $$  | $$| $$      
| $$$$$$$/|  $$$$$$$  |  $$$$/|  $$$$$$/| $$  | $$|  $$$$$$$  |  $$$$/|  $$$$$$/| $$      
|_______/  \_______/   \___/   \______/ |__/  |__/ \_______/   \___/   \______/ |__/      
...
\____   )MMMMMM|   .'
     `-'       `--'
EOT
echo -e "\t\tWelcome to Detonator Exploit ToolBox - Lets set up shop!"
echo -e "$r##################################################################$e"
...
\____   )MMMMMM|   .'
     `-'       `--'
EOT
echo -e "\t\tWelcome to Detonator Exploit ToolBox"
echo -e "$r##################################################################$e"
check_use
